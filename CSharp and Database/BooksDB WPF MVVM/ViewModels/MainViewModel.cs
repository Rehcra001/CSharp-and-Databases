...
namespace BooksDB_WPF_MVVM.ViewModels
{
    class MainViewModel : BaseViewModel
    {
        ...
        public ICommand NavigateToPublisherViewCommand { get; set; }
        public MainViewModel(INavigationService navigation, ISharedDataService sharedDataService)
        {
            ...
            NavigateToPublisherViewCommand = new RelayCommand(NavigateToPublisherView, CanNavigateToPulisherView);

            SharedData = sharedDataService;
        }

        private bool CanNavigateToPulisherView(object obj)
        {
            return true;
        }

        private void NavigateToPublisherView(object obj)
        {
            Navigation.NavigateTo<PublisherViewModel>();
        }
